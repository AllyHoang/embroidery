...
<head>
	...
	<title>Ally's Little Corner - order page</title>
</head>
<body>
	...
	<div class="main">
		...
		<section class="orders">
				<div class="title">
					...
					<h1>my orders</h1>
					<p> We can't wait to give you the best products we have to offer!
                </p>
				</div>
				<div class="box-container">
					...
					<?php 
							...
							echo '<p class="empty">no order has taken place yet!</p>';
						}
					?>
				</div>
